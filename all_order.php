...
<body>
    ...
    <a href="#" class="order-link"><i class="fas fa-box"></i> Orders</a>
    <div class="dropdown-menu" style="display: none;">
        <a href="admincancelledOrders.php" class="dropdown-item">Cancelled Orders</a>
        <a href="adminClaimed0rder.php" class="dropdown-item">Claimed Orders</a>
    ...
    <a href="salesReport.php"><i class="fas fa-file-alt"></i> Sales Report</a>
        ...
        <div class="content">
            ...
            <button id="deleteAllButton" style="background-color: red; color: white; border: none; border-radius: 5px; padding: 10px; cursor: pointer; margin-bottom: 10px;">Delete All Orders</button>
...
document.addEventListener("DOMContentLoaded", function() {
    const productLink = document.querySelector(".order-link");
